...
replace (
	github.com/filecoin-project/sector-storage => /golang/src/filecoin-project/sector-storage
	github.com/filecoin-project/storage-fsm => /golang/src/filecoin-project/storage-fsm
)
